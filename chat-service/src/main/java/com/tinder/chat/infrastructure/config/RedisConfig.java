...
import com.tinder.chat.infrastructure.adapter.in.redis.RedisChatSubscriberAdapter;
import com.tinder.chat.infrastructure.adapter.in.redis.RedisPresenceSubscriberAdapter;
...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisContainer(
            ...
            RedisChatSubscriberAdapter chatHandlers,
            RedisPresenceSubscriberAdapter presenceHandlers,
        ...
        container.addMessageListener(
                createAdapter(chatHandlers, "handleMessageEditedEvent"),
                new ChannelTopic(chatProperties.editChannel())
        );
