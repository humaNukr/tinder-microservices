...
public record GatewayAuthProperties(boolean enabled, String headerName, String expectedValue, String userIdHeader,
		String internalPathPrefix, List<String> publicPathPrefixes) {
